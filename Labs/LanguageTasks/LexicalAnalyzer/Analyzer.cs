...
{
	public enum LexemeType { Do, While, Loop, Not, And, Or, Output, Relation, ArithmeticOperation, Assignment, Undefined }
	...
	public class Analyzer
	{
		...
		private void AddLexeme(State prevState, string value)
		{
			...
			{
				bool isKeyword = true;
				if (value.ToLower() == "not") lexType = LexemeType.Not;
				else if (value.ToLower() == "and") lexType = LexemeType.And;
				else if (value.ToLower() == "or") lexType = LexemeType.Or;
				else if (value.ToLower() == "loop") lexType = LexemeType.Loop;
				else if (value.ToLower() == "output") lexType = LexemeType.Output;
				else if (value.ToLower() == "do") lexType = LexemeType.Do;
				else if (value.ToLower() == "while") lexType = LexemeType.While;
				else
				{
					lexType = LexemeType.Undefined;
					isKeyword = false;
